...
MAINTAINER Will Dent <will@dent.ly>
...
# Install Prestashop
ADD	http://www.prestashop.com/download/old/prestashop_1.5.6.1.zip /prestashop.zip
RUN	unzip /prestashop.zip -d /usr/share/nginx
